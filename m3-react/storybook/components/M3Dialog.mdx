...
- `M3Dialog.Icon` for a leading visual cue
- `M3Dialog.Header` for the title area
- default content for supporting text or compact form controls
- `M3Dialog.Footer` for high-signal actions
